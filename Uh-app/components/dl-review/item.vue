	...
	<view class="content">
		<view class="cenHost">
			 <view class="cenHeadImgContent">
				...
				<image class="headImg"
				       :src="reviewMsg.param2 || headImg"></image>
			</view> 
			<view class="cenHostMsgContent">
				<view class="viewMb viewMb-space-between">
					<view>
						<text class="textSize">{{reviewMsg.userNickName}}</text>
				...
				<view class="viewMb">
					<text class="cenHostMsg3 textCenMsg">#{{reviewMsg.param1}}</text>
					<text class="cenHostMsg4 textCenMsg">{{reviewMsg.createTime}}</text>
				</view>
				<view class="cenHostReview viewMb">
					<text class="textSendMsg">{{reviewMsg.comment}}</text>
				</view>
				<!-- <view class="iconRow">
					<view> 
