	...
	<view class="user">
		...
		<view class="user-section">
			...
			<view class="user-info-box">
				<view class="portrait-box" @tap="navTo(userInfo.phonenumber ? '/pages/user/userinfo/userinfo' : '/pages/public/login')">
					<image class="portrait"
					       :src="userInfo.head_portrait || headImg"></image>
					<text class="username">
						{{ userInfo.userName || userInfo.phonenumber||'请先登录'}}
					</text>
				</view>
			</view>
			<!--vip信息-->
		...
		>
			...
			<!-- 我的订单 -->
			<view class="promotion-center">
				<list-cell icon="iconshoucang" iconColor="#e07472"
