	...
	export default {
      ...
      // 注册账号
			async toRegister() {
				...
				/* this.reqBody['inviteCode'] = this.registerParams['nickname']; */
				...
				this.reqBody['inviteCode'] = this.registerParams['promoCode'];
				/*  #ifdef  APP-PLUS  */
				...
				/*  #endif  */
				this.reqBody['password'] =md5(this.registerParams['password'])
				this.btnLoading = true;
				console.log(this.reqBody)
				await this.$http.post(registerByPass,JSON.stringify(this.reqBody)).then(res => {
					if(res.data.code ==200){
						...
						this.$mHelper.toast(res.data.msg);
					}
